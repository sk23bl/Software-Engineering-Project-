...
Original file is located at
    https://colab.research.google.com/drive/1QYu10SU7YgtXIQVmMtao_RnK4mBnYWdy
"""
...
file_path = "20230914_080417_issue_sharings.json"  # Replace with the actual file path
...
csv_file_path = "file.csv"  # Replace with the desired CSV file path
...
# Read CSV data
csv_file_path = "file.csv"  # Replace with the actual CSV file path
